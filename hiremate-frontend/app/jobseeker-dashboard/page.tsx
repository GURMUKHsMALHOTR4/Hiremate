...
export default function JobSeekerDashboard() {
  ...
  const fetchJobs = async (
    ...
    try {
      ...
      const appliedRes = await fetch(
        `${API_BASE_URL}/api/applications/jobIdsByUser`,
        {
          headers: {
            Authorization:
              `Bearer ${getToken()}`,
  ...
  const handleFileSubmit = async () => {
    ...
    try {
      ...
      // ✅ Store recruiter in local chats
      if (selectedRecruiter) {
        ...
        if (!alreadyExists) {
          ...
          existingChats.push({
            ...
            username:
              selectedRecruiter.recruiterUsername,
          })
      ...
      toast({
        ...
        description:
          `Resume submitted for job ID: ${selectedJobId}`,
      })
          ...
          <Button
            onClick={() =>
              window.location.href =
                "/jobseeker-dashboard/notifications"
            }
          >
            🔔 Notifications
          </Button>
