...
public class ApplicationController {
    ...
    public ResponseEntity<?> applyToJob(
        ...
        File destination =
                new File(uploadDir, uniqueFilename);
    ...
    // ✅ CURRENT USER APPLIED JOB IDS
    @GetMapping("/jobIdsByUser")
    public ResponseEntity<List<Long>>
    getAppliedJobIdsByUser(
            @AuthenticationPrincipal
            CustomUserDetails userDetails
    ) {
    ...
    public ResponseEntity<?> updateStatus(
        ...
        return ResponseEntity.ok(
                "✅ Application status updated to " + up
        );
    }
    ...
    // ✅ CHAT ELIGIBLE RECRUITERS
    @GetMapping("/chat-eligible-recruiters/{userId}")
    public ResponseEntity<List<Map<String, Object>>>
    getChatEligibleRecruiters(
            @PathVariable Long userId
    ) {
